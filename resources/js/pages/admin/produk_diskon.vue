<template>
    <div>
        <Navbar></Navbar>
        <div
            class="container-fluid min-vh-100 mt-5 bg-silver d-flex align-items-center justify-content-center pt-5 pt-lg-0"
        >
            <div v-if="load" class="spinner-border text-primary" role="status">
                <span class="visually-hidden">Loading...</span>
            </div>
            <div v-if="!load" class="container card py-3 overflow-auto my-5">
                <div
                    class="d-flex w-100 justify-content-between align-items-center"
                >
                    <h3 class="fw-bold m-0">Data Produk Diskon</h3>
                    <button
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <input
                                    v-model="nama"
                                    placeholder="ex: Redmi Note 10 Pro"
                                    class="form-control mb-3 shadow-none"
                                />
                                <label>Harga Asli Produk:</label>
                                <input
                                    v-model="harga_asli"
                                    placeholder="ex: Rp 3.990.000"
                                    class="form-control mb-3 shadow-none"
                                />
                                <label>Harga Diskon Produk:</label>
                                <input
                                    v-model="harga_diskon"
                                    placeholder="ex: Rp 3.550.000"
                                    class="form-control mb-3 shadow-none"
                                />
                                <label>Keterangan Produk:</label>
                                <input
                                    v-model="keterangan"
                                    placeholder="Baru / Second"
                                    class="form-control mb-3 shadow-none"
                                />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <label>Harga Diskon Produk:</label>
                                <input
                                    :value="e.harga_diskon"
                                    :id="'harga_diskon-' + e.id"
                                    placeholder="ex: Rp 3.550.000"
                                    class="form-control mb-3 shadow-none"
                                />
                                <label>Keterangan Produk:</label>
...
export default {
    ...
    methods: {
        ...
        tambah() {
            ...
            data.append("harga_asli", this.harga_asli);
            data.append("harga_diskon", this.harga_diskon);
            data.append("keterangan", this.keterangan);
            data.append("detail", this.detail);

            this.axios
                .post("/api/produk/diskon/store", data)
                .then((res) => {
                    this.berhasil = true;
                    this.nama = "";
                    this.gambar = "";
        ...
        edit(id) {
            ...
            let harga_asli = document.querySelector(`#harga_asli-${id}`).value;
            let harga_diskon = document.querySelector(
                `#harga_diskon-${id}`
            ).value;
            let detail = document.querySelector(`#detail-${id}`).value;
            let keterangan = document.querySelector(`#keterangan-${id}`).value;

            let data = new FormData();
            data.append("id", id);
            data.append("token", localStorage.HP_TOKEN);
            data.append("nama", nama);
            data.append("harga_asli", harga_asli);
            data.append("harga_diskon", harga_diskon);
            data.append("keterangan", keterangan);
            data.append("detail", detail);

            this.axios
                .post("/api/produk/diskon/update", data)
                .then((res) => {
