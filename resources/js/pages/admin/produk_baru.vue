<template>
    <div>
        ...
        >
            ...
            <div v-if="!load" class="container card py-3 overflow-auto mt-5">
                <div
                    class="d-flex w-100 justify-content-between align-items-center"
                >
                    <h3 class="fw-bold m-0">Data Produk Baru</h3>
                    <button
...
export default {
    ...
    methods: {
        ...
        tambah() {
            ...
            this.axios
                .post("/api/produk/baru/store", data)
                .then((res) => {
                    this.berhasil = true;
                    this.nama = "";
                    this.gambar = "";
        ...
        edit(id) {
            ...
            this.axios
                .post("/api/produk/baru/update", data)
                .then((res) => {
