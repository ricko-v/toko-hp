<template>
    <div>
        <Navbar></Navbar>
        <div
            class="container-fluid min-vh-100 bg-silver d-flex mt-5 align-items-center justify-content-center pt-5 pt-lg-0"
        >
            ...
            <div v-if="!load" class="container card py-3 overflow-auto">
                ...
                >
                    <h3 class="fw-bold m-0">Data Produk Second</h3>
                    <button
...
export default {
    ...
    methods: {
        ...
        tambah() {
            ...
            this.axios
                .post("/api/produk/second/store", data)
                .then((res) => {
                    this.berhasil = true;
                    this.nama = "";
                    this.gambar = "";
        ...
        edit(id) {
            ...
            let harga = document.querySelector(`#harga-${id}`).value;
            ...
            this.axios
                .post("/api/produk/second/update", data)
                .then((res) => {
