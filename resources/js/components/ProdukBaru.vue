            ...
            >
                <div class="d-flex align-items-center">
                    <svg
                        ...
                        fill="currentColor"
                        viewBox="0 0 16 16"
                        class="bi bi-node-plus text-purple"
                    >
                        <path
                            fill-rule="evenodd"
                    ...
                    <b class="ms-2 fw-bold">Produk Baru</b>
                </div>
                <div>
